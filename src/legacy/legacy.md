...
```
{
  "filesystem": {
    ...
    "args": [
      "-y",
      "@modelcontextprotocol/server-filesystem",
      "/Users/rlm/Desktop/Code/research_agent/src/legacy/files"
    ],
    "transport": "stdio"
  }
}
...
(6) Follow [here[(https://github.com/langchain-ai/research_agent/issues/75#issuecomment-2811472408) to use with OpenRouter.

(7) For working with local models via Ollama, see [here](https://github.com/langchain-ai/research_agent/issues/65#issuecomment-2743586318).

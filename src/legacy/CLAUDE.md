...
The **graph-based implementation** (`src/research_agent/graph.py`) follows a structured plan-and-execute workflow:
...
The **multi-agent implementation** (`src/research_agent/multi_agent.py`) uses a supervisor-researcher architecture:
